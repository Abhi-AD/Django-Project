const imageData = [
     ...
     {
          src: "https://images.unsplash.com/photo-1530549387789-4c1017266635?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHw0fHxzcG9ydHxlbnwwfDB8fHwxNzIxMDQzMjkxfDA&ixlib=rb-4.0.3&q=80&w=1080",
          alt: "Sport",
          title: "Swimming",
     },
     {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                         {imageData.map((image, index) => (
                              <div key={index} className={`relative overflow-hidden rounded-2xl shadow-lg group ${image.span || ''}`}>
                                   <img src={image.src} alt={image.alt} className="w-full h-48 md:h-full object-cover" />
