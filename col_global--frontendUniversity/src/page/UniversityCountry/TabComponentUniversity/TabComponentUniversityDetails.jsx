     ...
     return (
          <div>
               ...
               <div id="default-tab-content">
                    ...
                    <div className={`${activeTab === 'admissions' ? 'block' : 'hidden'} p-4 rounded-lg  dark:bg-gray-800`} id="admissions" role="tabpanel" aria-labelledby="campus-life-tab">
                         <Admission />
                    </div>
                    <div className={`${activeTab === 'academics' ? 'block' : 'hidden'} p-4 rounded-lg  dark:bg-gray-800`} id="academics" role="tabpanel" aria-labelledby="academics-tab">
                         <Academics />
                    </div>
                    <div className={`${activeTab === 'costs' ? 'block' : 'hidden'} p-4 rounded-lg  dark:bg-gray-800`} id="costs" role="tabpanel" aria-labelledby="costs-tab">
                         <Costs />
                    </div>
                    <div className={`${activeTab === 'campus-life' ? 'block' : 'hidden'} p-4 rounded-lg  dark:bg-gray-800`} id="campus-life" role="tabpanel" aria-labelledby="campus-life-tab">
                         <CampusLife />
                    </div>
