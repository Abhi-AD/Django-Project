...
const Card = ({ scholarship_name, tags, collagename, link, DarkMode, location, coursename }) => (
               ...
               <div className="p-3 flex flex-col justify-between">
                    <div className="flex flex-col gap-4">
                         <div className="flex flex-col gap-1">
                              ...
                              <div className={` truncate ${DarkMode ? "" : "text-gray-800"} text-[20px] flex gap-1 items-center`}><CiFlag1 /> <p className="text-sm">{location}</p></div>
                         </div>
